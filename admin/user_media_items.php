...
$query="SELECT p.* , c.* FROM posts p INNER JOIN categories c ON c.id = p.category_id WHERE (p.post_type='photo' OR p.post_type='video') AND p.approved=1 ";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Unapproved posts</h4>
